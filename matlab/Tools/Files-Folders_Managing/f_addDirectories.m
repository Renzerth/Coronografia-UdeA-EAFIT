function [analysDir,toolsDir,dataDir,outDir] = f_addDirectories(analysFldr,toolsFldr,dataFlrd,outFlrd,pathSep)
...
analysDir = f_makeParentFolder(dirabove,analysFldr,pathSep); % Adds the directory
% analysDir = pwd; % Same functionality
toolsDir = f_makeParentFolder(dirabove,toolsFldr,pathSep); % Adds the directory
dataDir = f_makeParentFolder(dirabove,dataFlrd,pathSep); % Adds the directory
