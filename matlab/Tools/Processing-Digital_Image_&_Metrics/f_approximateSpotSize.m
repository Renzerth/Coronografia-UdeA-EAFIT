...
if nargin == 2
    ...
    Threshold = 0.3; % 70 percent of the energy  is considered. One only 
                     % analyzes this energy since it is significative in an
                     % Airy pattern. It is assumed that the central 
                     % intensity defines the spot's axis or 
                     % Works as a percentage since cdata is inside the 
                     % range 03.[0,1]
end
