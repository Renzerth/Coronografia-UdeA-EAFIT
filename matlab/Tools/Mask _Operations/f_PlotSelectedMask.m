...
switch maskSel 
 case 0 % Spiral phase mask or mapa de fase espiral or mascara espiral
  ...
  [mask,wrapMask,wrapMaskFig] = f_SpiralMask(r,phi,phaseValues,tc,s, ...
 ...
 case 1 % Laguerre-Gauss (LG) beams
  [mask,wrapMask,wrapMaskFig] = f_LGMask(r,phi,phaseValues,tc,s,ph0, ...
 ...
 case 3 % Elliptic Gaussian Vortex (EGV) mask or Vortice eliptico-gaussiano
  [mask,wrapMask,wrapMaskFig] = f_EGVMask(X,Y,r,phaseValues,tc,s, ...
...
%%%%%%%%%%%%%%%%%%%% NOT USED BUT FOR ACADEMIC PURPOSES %%%%%%%%%%%%%%%%%%%
 ...
 case 6 % Laguerre-Gauss (LG) + Zernike
  [mask,wrapMask,wrapMaskFig] = f_LGZernikeMask(X,Y,r,phi, ...
