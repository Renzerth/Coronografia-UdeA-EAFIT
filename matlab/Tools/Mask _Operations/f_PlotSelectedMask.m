...
frkTyp,Aalpha,Angalp,Angbet,z_coeff,a,frac,pupil,ZernikeSize,shiftCart, ...
shiftBool,disp_wrap,plot_z, normMag,binMask,binv,monitorSize,scrnIdx,coordType,abs_ang,MaxMask,plotMask,  ...
maskSel)                                        
% Inputs:
...
switch maskSel 
 ...
 case 1 % Laguerre-Gauss (LG) beams
  ...
  levShft,tc,s,ph0,p,WsizeRatio,normMag,binMask,binv,monitorSize,scrnIdx, ...
 ...
 case 4 % Threefold dislocation hologram or double pitch fork hologram or
  ...
  normMag,binMask,binv,monitorSize,scrnIdx,coordType,abs_ang,MaxMask, ...
  plotMask);
  maskName = 'Fork';
...
%%%%%%%%%%%%%%%%%%%% NOT USED BUT FOR ACADEMIC PURPOSES %%%%%%%%%%%%%%%%%%%
 case 5 % Zernike (aberrations)
  ...
  phaseValues,mingl,maxgl,levShft,pupil,ZernikeSize,shiftCart,shiftBool, ...
  disp_wrap,plot_z,normMag,binMask,binv,monitorSize,scrnIdx,coordType,MaxMask,plotMask);
  maskName = 'Zernike';
                  
 case 6 % Laguerre-Gauss (LG) + Zernike
  [mask,wrapMask,wrapMaskFig] = f_LGZernikeMask(r,phi,gl,phaseValues,mingl, ...
  maxgl,levShft,tc,s,ph0,p,WsizeRatio,z_coeff,a,frac,L,pupil,ZernikeSize,shiftCart, ...
  shiftBool,disp_wrap,plot_z,normMag,binMask,binv,monitorSize,scrnIdx,coordType,abs_ang, ...
  MaxMask,plotMask);
  maskName = 'LG_Zernike';       
