...
switch maskSel 
 ...
 case 2 % Vortex Producing Lens (VPL) = Helicoidal + Fresnel lens
  ...
  levShft,tc,s,ph0,L,f_FR,normMag,binMask,binv,MaskPupil,monitorSize,scrnIdx, ...
  coordType,abs_ang,MaxMask,plotMask);
  maskName = 'VPL';
 ...
 case 3 % Elliptic Gaussian Vortex (EGV) mask or Vórtice elíptico-gaussiano
  ...
  levShft,tc,s,ph0,bcst,normMag,binMask,binv,MaskPupil,monitorSize,scrnIdx, ...
  coordType,abs_ang,MaxMask,plotMask);
  maskName = 'EGV';
 ...
 case 4 % Threefold dislocation hologram or double pitch fork hologram or
  ...
  normMag,binMask,binv,MaskPupil,monitorSize,scrnIdx,coordType,abs_ang,MaxMask, ...
  plotMask);
  maskName = 'Fork';
...
%%%%%%%%%%%%%%%%%%%% NOT USED BUT FOR ACADEMIC PURPOSES %%%%%%%%%%%%%%%%%%%
 case 5 % Zernike (aberrations)
  ...
  disp_wrap,plot_z,normMag,binMask,binv,MaskPupil,monitorSize,scrnIdx,coordType,MaxMask,plotMask);
  maskName = 'Zernike';
 ...
 case 6 % Laguerre-Gauss (LG) + Zernike
  ...
  disp_wrap,plot_z,normMag,binMask,binv,MaskPupil,monitorSize,scrnIdx,coordType,abs_ang, ...
  MaxMask,plotMask);
  maskName = 'LG_Zernike';       
