...
%%%%%%%%%%%%%%%%%%%% NOT USED BUT FOR ACADEMIC PURPOSES %%%%%%%%%%%%%%%%%%%
 case 5 % Zernike (aberrations)
  [mask,wrapMask,wrapMaskFig] = f_ZernikeMask(X,Y,r,z_coeff,a,frac,L,gl, ...
  phaseValues,mingl,maxgl,levShft,pupil,ZernikeSize, ...
  disp_wrap,plot_z,normMag,binMask,binv,MaskPupil,rSize,monitorSize,scrnIdx,coordType,MaxMask,plotMask);
  maskName = 'Zernike';
                  
 case 6 % Laguerre-Gauss (LG) + Zernike
  [mask,wrapMask,wrapMaskFig] = f_LGZernikeMask(X,Y,r,phi,gl,phaseValues,mingl, ...
  maxgl,levShft,tc,s,ph0,p,WsizeRatio,z_coeff,a,frac,L,pupil,ZernikeSize, ...
  disp_wrap,plot_z,normMag,binMask,binv,MaskPupil,rSize,monitorSize,scrnIdx,coordType,abs_ang, ...
  MaxMask,plotMask);
  maskName = 'LG_Zernike';       
