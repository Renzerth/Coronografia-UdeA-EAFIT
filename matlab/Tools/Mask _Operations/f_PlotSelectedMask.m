...
frkTyp,Aalpha,Angalp,Angbet,z_coeff,a,frac,pupil,ZernikeSize,disp_wrap,plot_z,...
...
%%%%%%%%%%%%%%%%%%%% NOT USED BUT FOR ACADEMIC PURPOSES %%%%%%%%%%%%%%%%%%%
 case 5 % Zernike (aberrations)
  ...
  phaseValues,mingl,maxgl,levShft,pupil,ZernikeSize,disp_wrap,plot_z,normMag, ...
 ...
 case 6 % Laguerre-Gauss (LG) + Zernike
  ...
  maxgl,levShft,tc,s,ph0,p,WsizeRatio,z_coeff,a,frac,L,pupil,ZernikeSize,disp_wrap, ...
