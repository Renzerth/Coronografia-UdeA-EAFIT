...
function [mask,wrapMask,wrapMaskFig] = f_LGZernikeMask(r,phi,gl,glphi, ...
...
showEachMask = 0;
[maskZ,~,~]= f_ZernikeMask(r,z_coeff,a,frac,L,gl,glphi,mingl,maxgl, ...
levShft,pupil,sSize,disp_wrap,plot_z,normMag,binMask,binv,monitorSize, ...
scrnIdx,coordType,showEachMask);
[maskLG,~,~] = f_LGMask(r,phi,gl,glphi,mingl,maxgl,levShft,tc,s,ph0,p, ...
