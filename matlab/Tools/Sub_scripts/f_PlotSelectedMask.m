...
phiPC,gl,glphi,mingl,maxgl,levShft,tc,s,ph0,p,W,binvLG,normLG,L,f_FR,bcst, ...
...
switch maskSel 
 ...
 case 1 % Laguerre-Gauss (LG) beams
  ...
  tc,s,ph0,p,W,binvLG,normLG,binMask,monitorSize,scrnIdx,coordType, ...
  abs_ang,plotMask);
  maskName = 'LG';
...
%%%%%%%%%%%%%%%%%%%% NOT USED BUT FOR ACADEMIC PURPOSES %%%%%%%%%%%%%%%%%%%
 ...
 case 6 % Laguerre-Gauss (LG) + Zernike
  mask = f_LGZernikeMask(rSLM,phiSLM,rPC,phiPC,gl,glphi,mingl,maxgl, ...
         levShft,tc,s,ph0,p,W,binvLG,normLG,z_coeff,a,frac,L,pupil,sSize, ...
