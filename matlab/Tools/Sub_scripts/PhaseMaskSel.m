switch maskSel 
 ...
 case 0 % Spiral phase mask or mapa de fase espiral or máscara espiral
  ...
  mask = f_Spiral_Mask(x,y,r,phi,gl,glphi,mingl,maxgl,levShft,tc,s,ph0, ...
                       binMask,showM);
  maskName = 'Spiral';
   
 case 1 % Laguerre-Gauss (LG) beams
  mask = f_LG_Mask(x,y,r,phi,gl,glphi,mingl,maxgl,levShft,tc,s,ph0,p,W, ...
                   binv,norm,abs_ang,binMask,monitorSize,showM);
  maskName = 'LG';
  
 case 2 % Vortex Producing Lens (VPL) = Helicoidal + Fresnel lens
  mask = f_VPL_Mask(x,y,r,phi,gl,glphi,mingl,maxgl,levShft,tc,s,ph0,L, ...
                    f_FR,binMask,showM);
  maskName = 'VPL';
  
 case 3 % Elliptic Gaussian Vortex (EGV) mask or Vórtice elíptico-gaussiano
  mask = f_EGV_Mask(x,y,X,Y,r,gl,glphi,mingl,maxgl,levShft,tc,s,ph0, ...
                    bcst,binMask,showM);
  maskName = 'EGV';
