...
if meas
 ...
 if measDebug == 1 && measSimulated == 0
  ...
  totalImgs,wait,imgpartPath,dataformat,measfullpath,infoDelim, ...
...
if proc
  A = f_ProcessData(measfullpath,pathSep,dataformat,cameraPlane,n,PP,M,f,ProcessedDir,wait,infoDelim); % Metric of the degree of extintion applied
