...
f_DefineSpace(sSupport,sSize,shiftCart,shiftBool,pixSize,scrnIdx,circularMask, ...
coordType,MaxMask,plotMask,maskSel);
...
Angalp,Angbet,z_coeff,a,frac,pupil,ZernikeSize,shiftCart,shiftBool,disp_wrap,plot_z,normMag, ...
...
[DatalogDir,ltcvect,lglvect] = f_CreateFoldersRegisters(maskName,tcvect,...
 ...
 if measDebug == 1
  ...
  phiPC,phaseValues,mingl,maxgl,levShft,s,ph0,p,W,L,f_FR,bcst,period,T0,...
