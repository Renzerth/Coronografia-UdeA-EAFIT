...
shiftCart] = f_DefineSpace(vid,sSupport,sSize,shiftCart,shiftMask, ...
pixSize,scrnIdx,circularMask,z_pupil,coordType,MaxMask,maskSel);
 ...
 switch useLastMeas 
  ...
  case 1 % Loads the last measurement
    clearvars -except dataDir pathSep numberedFolderMeas ProcessedDir ...
                      metricSel metricProfile AiryFactor NA useLastMeas; 
...
if proc 
    ...
    AiryFactor,metricSel,metricProfile,shiftCart,beepSound,L,NA,PP);
end
