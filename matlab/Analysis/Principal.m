...
[mask,maskName] = f_PlotSelectedMask(Xslm,Yslm,rSLM,phiSLM,Xpc,Ypc,rPC, ...
phiPC,gl,glphi,mingl,maxgl,levShft,tc,s,ph0,p,W,binvLG,normLG,L,f_FR, ...
bcst,z_coeff,a,frac,pupil,sSize,disp_wrap,plot_z,binMask,monitorSize, ...
