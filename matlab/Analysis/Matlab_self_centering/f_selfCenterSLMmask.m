function [shiftY, shiftX, systemPupilPixelSIze, mainDataCenter, mainDataRadius] = f_selfCenterSLMmask(detectorPixelPitch, systemPupilSIze, screenIndex, vid)
%% Set Reference
close all;
preview(vid);
...
[X,Y,rhoRadius, monitorSize] = f_makeScreenCoordinates(screenIndex);
